...
mclient
  .connect(`mongodb+srv://${process.env.MONGO_USERNAME}:${process.env.MONGO_PASSWORD}@travel.txamtgm.mongodb.net/?retryWrites=true&w=majority&appName=travel`, { useNewUrlParser: true
  })
  .then((dbRef) => {
